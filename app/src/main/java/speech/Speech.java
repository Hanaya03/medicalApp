...
public class Speech {
     ...
     * @throws speech.SpeechRecognitionNotAvailable      when speech recognition is not available on the device
     * @throws GoogleVoiceTypingDisabledException when google voice typing is disabled on the device
     */
    public void startListening(final speech.SpeechDelegate delegate)
            throws speech.SpeechRecognitionNotAvailable, GoogleVoiceTypingDisabledException {
     ...
     * @throws GoogleVoiceTypingDisabledException when google voice typing is disabled on the device
     */
    public void startListening(final SpeechProgressView progressView, final speech.SpeechDelegate delegate)
            throws speech.SpeechRecognitionNotAvailable, GoogleVoiceTypingDisabledException {
     ...
     */
    public void say(final String message, final speech.TextToSpeechCallback callback) {
     ...
     */
    public void getSupportedSpeechToTextLanguages(speech.SupportedLanguagesListener listener) {
        if (!isGoogleAppInstalled()) {
            listener.onNotSupported(speech.UnsupportedReason.GOOGLE_APP_NOT_FOUND);
            return;
        }
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (extras != null && extras.containsKey(RecognizerIntent.EXTRA_SUPPORTED_LANGUAGES)) {
                    ...
                    if (languages == null || languages.isEmpty()) {
                        listener.onNotSupported(speech.UnsupportedReason.EMPTY_SUPPORTED_LANGUAGES);
                    } else {
